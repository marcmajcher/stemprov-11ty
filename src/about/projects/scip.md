...
But these approaches often assume there's a single "right" way to communicate—one that overlooks how scientists' identities, cultures, values, and lived experiences shape both how they communicate and how audiences respond.
...
### Begin with identity, not messaging

Many communication trainings begin with techniques.
...
Instead of only discussing communication strategies, participants actively rehearsed them.

Using improvisation and Theatre of the Oppressed, scientists experimented with responding to challenging situations, navigating power dynamics, listening across difference, and adapting to unexpected conversations.
...
The fellowship was designed as more than a series of workshops.

Across immersive trainings and virtual learning sessions, participants developed relationships with one another, shared feedback on communication projects, and experimented with new approaches in a supportive community of practice.
...
Over three years, the project helped develop and test a culturally responsive science communication curriculum for early-career faculty from historically underrepresented racial and ethnic groups.
